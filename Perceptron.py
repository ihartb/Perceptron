...
class Perceptron:
    ...
    def demo(self, trainingFeatures, trainingLabels, percentTraining, cycles, validationFeatures, validationLabels):
        ...
        print("Time to Train: "+ str(time)+ " sec")
        accuracy = self.calculateAccuracy(validationFeatures, validationLabels)
